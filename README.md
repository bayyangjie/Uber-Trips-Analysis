...
### Revenue generated by Rate Code/Payment types
The barplots shows a comparison between the different rate code types in terms of total revenue. The rate codes Nassau/Westchester and Newark generate the most amount of revenue as compared to the other rate code types. In terms of revenue generated by the payment types, the bulk of the revenue generated came from payments through Credit Cards.
